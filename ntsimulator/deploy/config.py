...
mapping = dict({"ntsim-ng-o-ru": "highstreet-O-RU", "ntsim-ng-o-du": "highstreet-O-DU", "o-eNB": "o-eNB_test"}) 
...
def configEventSettings(nfName, nfType):
  ...
  with open(file) as json_file:
    ...
    try:
      #url_t = "https://sdnc-web:8453/rests/data/network-topology:network-topology/topology=topology-netconf/node=o-eNB_test/yang-ext:mount/nts-network-function:simulation/network-function/fault-generation/fault-delay-list=0"
      #response = requests.delete(url_t, verify=False, auth=(username, password))
...
for container in containers:
  ...
  if "ntsim-ng" in name:
    ...
    if "ntsim-ng-o-du" in name:
      ...
      print("Set", nfName, confsigEventSettings(nfName, "ntsim-ng-o-du"))
  if "o-eNB" in name:
    nfName = mapping["o-eNB"]
    print("~~")
    print("Set", nfName, configEventSettings(nfName, "o-ran-du"))